...
*
* TODO Merge this with our more general cache.
* 
...
*/
case class CachedAction(key: RequestHeader => String, duration: Int)(action: EssentialAction)(implicit app: Application) extends EssentialAction {
...
object CachedAction {
  ...
  /**
	...
	* @param action Action to cache
	*/
  def apply(key: String, duration: Int)(action: EssentialAction)(implicit app: Application): CachedAction = {
    CachedAction(_ => key, duration)(action)
  }
